    ...
    var nude = new (function() {
        ...
        // private functions
            ...
            scanImage = function() {
                ...
                var myWorker = new Worker(webroot + 'js/libs/worker.nude.js'),
        ...
        return {
            init: function() {
                ...
                if (!!!window.Worker) {
                    document.write(unescape("%3Cscript src='" + webroot + "js/libs/noworker.nude.js' type='text/javascript'%3E%3C/script%3E"));
                }
